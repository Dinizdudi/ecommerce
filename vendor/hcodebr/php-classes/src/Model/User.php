...
class User extends Model{
	...
	const SESSION = "User";
	const SECRET = "HcodePhp7_Secret"; //chave de criptografia, sempre tem que ter PELO MENOS 16 caracteres
	...
	public static function login($login, $password){
		...
		if (password_verify($password, $data["despassword"]) === true){
			...
			$user->setData($data); //manda para o metodo que faz os sets dinamicamente.
